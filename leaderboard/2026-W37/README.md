# Crovia AI Continuity Leaderboard — 2026-W37
...
- **Cumulative target-time observed:** 603,492 target-days
- **Median silence per target:** 201 days
- **Longest-silent target:** `meta-llama/Llama-3.1-8B` — 232 days, since 2026-01-17
...
import csv
fp = hf_hub_download("crovia/continuity-leaderboard", "2026-W37/top_silent.csv", repo_type="dataset")
...
```bash
curl https://croviatrust.com/registry/data/leaderboard/2026-W37/snapshot.json | jq
```
...
Data: **CC-BY-4.0**. Attribute as: "Crovia continuity leaderboard, week 2026-W37".
