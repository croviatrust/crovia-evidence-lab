# Crovia AI Continuity Leaderboard — 2026-W36
...
- **Real targets tracked:** 2,951
- **Cumulative target-time observed:** 582,835 target-days
- **Median silence per target:** 194 days
- **Longest-silent target:** `meta-llama/Llama-3.1-8B` — 225 days, since 2026-01-17
...
import csv
fp = hf_hub_download("crovia/continuity-leaderboard", "2026-W36/top_silent.csv", repo_type="dataset")
...
```bash
curl https://croviatrust.com/registry/data/leaderboard/2026-W36/snapshot.json | jq
```
...
Data: **CC-BY-4.0**. Attribute as: "Crovia continuity leaderboard, week 2026-W36".
