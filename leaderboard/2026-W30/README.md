# Crovia AI Continuity Leaderboard — 2026-W30
...
- **Real targets tracked:** 2,953
- **Cumulative target-time observed:** 459,259 target-days
- **Median silence per target:** 152 days
- **Longest-silent target:** `meta-llama/Llama-3.1-8B` — 183 days, since 2026-01-17
...
import csv
fp = hf_hub_download("crovia/continuity-leaderboard", "2026-W30/top_silent.csv", repo_type="dataset")
...
```bash
curl https://croviatrust.com/registry/data/leaderboard/2026-W30/snapshot.json | jq
```
...
Data: **CC-BY-4.0**. Attribute as: "Crovia continuity leaderboard, week 2026-W30".
